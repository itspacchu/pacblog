...
const CACHE_NAME = "NewtonShader-cache";
const OFFLINE_URL = "NewtonShader.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["NewtonShader.html","NewtonShader.js","NewtonShader.wasm","NewtonShader.pck","NewtonShader.offline.html","NewtonShader.icon.png","NewtonShader.apple-touch-icon.png"];
